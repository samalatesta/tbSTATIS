...
We present the plot from  running the plot_events function with TBebmData. The y axis is ordered as X1, X6, X3, X2, X4, X5. This aligns with our ground truth sequence where X1, X6, and X3 occur at stage 1 followed by X2, X4, and X5 at stages 2, 3, and 4, respectively. We see our data align well with the ground truth sequence overall with little to know events occurring in the upper left hand portion of the plot. This is result of us using a value of .9 for all clinical events when we simulated our data set. If p was lower, we would expect to see more variation. 
```{r plot events}
